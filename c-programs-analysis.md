...
*   [`pointer_assignment.c`](07-pointers/pointer_assignment.c): Demonstrates how assigning one pointer to another changes the target of the first pointer.
*   [`pointer_dereference_and_assignment.c`](07-pointers/pointer_dereference_and_assignment.c): Demonstrates how pointers are assigned, dereferenced to read values, and dereferenced to modify the original variable's value.
*   [`pointer_dereference_simple.c`](07-pointers/pointer_dereference_simple.c): Demonstrates the basic concept of dereferencing a pointer to access the value of the variable it points to.
*   [`pointer_modify_value.c`](07-pointers/pointer_modify_value.c): Demonstrates how to use a pointer to access and modify the value of a variable.
*   [`pointer_to_array_element.c`](07-pointers/pointer_to_array_element.c): Demonstrates assigning a pointer to a specific element of an array and dereferencing it.
*   [`pointer_to_pointer_address.c`](07-pointers/pointer_to_pointer_address.c): Demonstrates printing the address of a pointer to a pointer.
*   [`pointer_to_pointer_example.c`](07-pointers/pointer_to_pointer_example.c): Demonstrates the concept of a pointer to a pointer.
...
*   [`string_concatenation_manual.c`](08-strings/string_concatenation_v2.c): Demonstrates how to concatenate two strings into a third string manually using loops.
*   [`string_concatenation.c`](08-strings/string_concatenation_v2.c): Demonstrates concatenating two strings.
*   [`string_copy_example.c`](08-strings/string_copy_v3.c): Demonstrates reading two strings, copying the first to the second, and printing the result.
*   [`string_copy_manual.c`](08-strings/string_copy_v3.c): Demonstrates how to copy one string to another character by character using a loop.
*   [`string_copy_pointer.c`](08-strings/string_copy_v3.c): Demonstrates string copying using strcpy and pointer manipulation.
*   [`string_formatting_printf.c`](08-strings/string_formatting_precision.c): Demonstrates string formatting using printf with width and precision specifiers.
*   [`string_input_output_v1.c`](08-strings/string_input_output_scanf.c): Demonstrates reading a string from input and printing it.
*   [`string_input_output_v2.c`](08-strings/string_input_output_scanf.c): Demonstrates reading a string from input and printing it using `fgets()` and `puts()`.
*   [`string_input_output_v3.c`](08-strings/string_input_output_scanf.c): Demonstrates reading a string from input and printing it using `fgets()` and `puts()`.
*   [`string_input_output_v4.c`](08-strings/string_input_output_scanf.c): Demonstrates reading a string from input and printing it using `fgets()` and `puts()`.
*   [`string_input_output_v5.c`](08-strings/string_input_output_scanf.c): Demonstrates reading a string from input and printing it using `fgets()` and `puts()`.
*   [`string_input_output_v6.c`](08-strings/string_input_output_scanf.c): Demonstrates reading a string from input and printing it using `fgets()` and `puts()`.
*   [`string_input_output_v7.c`](08-strings/string_input_output_scanf.c): Demonstrates reading a string from input and printing it using `fgets()` and `puts()`.
*   [`string_input_output_v8.c`](08-strings/string_input_output_scanf.c): Demonstrates reading a string from input and printing it using `fgets()` and `puts()`.
*   [`string_input_output_v9.c`](08-strings/string_input_output_scanf.c): Demonstrates reading a string from input and printing it using `fgets()` and `puts()`.
*   [`string_input_output_v10.c`](08-strings/string_input_output_scanf.c): Demonstrates reading a string from input and printing it.
*   [`string_input_output_v11.c`](08-strings/string_input_output_scanf.c): Demonstrates reading a string from input and printing it.
*   [`string_input_output_v12.c`](08-strings/string_input_output_scanf.c): Demonstrates reading a string from input and printing it.
*   [`string_input_output_v13.c`](08-strings/string_input_output_scanf.c): Demonstrates reading a string from input and printing it.
*   [`string_input_output_v14.c`](08-strings/string_input_output_scanf.c): Demonstrates reading a string from input and printing it.
*   [`string_input_output_v15.c`](08-strings/string_input_output_scanf.c): Demonstrates reading a string from input and printing it using `fgets()` and `puts()`.
*   [`string_input_output_v16.c`](08-strings/string_input_output_scanf.c): Demonstrates reading a string from input and printing it.
*   [`string_input_output_v17.c`](08-strings/string_input_output_scanf.c): Demonstrates reading a string from input and printing it using `fgets()` and `puts()`.
*   [`string_input_output_v18.c`](08-strings/string_input_output_scanf.c): Demonstrates reading a string from input and printing it using `fgets()` and `puts()`.
*   [`string_input_pointer.c`](08-strings/string_input_output_printf.c): Demonstrates reading a string using `fgets()` and accessing it via a character pointer.
*   [`string_length_calculator.c`](08-strings/string_length_v3.c): Demonstrates reading lines from standard input and calculating their lengths.
*   [`string_length_check.c`](08-strings/string_length_v3.c): Reads a string and prints its length if the string's length is even or odd.
*   [`string_length_dynamic.c`](08-strings/string_length_v3.c): Reads a string from user input and calculates its length using dynamic memory allocation and `strlen()`.
*   [`string_length_function.c`](08-strings/string_passing_to_function_v2.c): Calculates and prints the length of a given string using a separate function.
*   [`string_length_manual.c`](08-strings/string_length_v3.c): Calculates and prints the length of a given string manually by iterating through characters until the null terminator.
*   [`string_manipulation_functions.c`](08-strings/string_manipulation_functions.c): Demonstrates string comparison (`strcmp`), length calculation (`strlen`), concatenation (`strcat`), and copying (`strcpy`).
*   [`string_palindrome_and_mirror_check.c`](08-strings/string_palindrome_and_mirror_check.c): Checks if a string is a palindrome, a mirrored string, or a mirrored palindrome.
*   [`string_palindrome_checker.c`](08-strings/string_palindrome_checker_v2.c): Checks if a given string is a palindrome.
*   [`string_palindrome_recursive.c`](08-strings/string_palindrome_checker_v2.c): Checks if a given string is a palindrome using a recursive function.
*   [`string_parsing_formatting.c`](08-strings/string_parsing_and_formatting.c): Demonstrates parsing strings with `sscanf` and formatting strings with `sprintf`.
...
*   [`string_reversal.c`](08-strings/string_reversal_regular.c): Reverses a given string in-place, including spaces, for multiple test cases.
*   [`string_reverse_recursive.c`](08-strings/string_reversal_recursive.c): Demonstrates reversing a string using recursion.
...
*   [`structure_array_sort_by_roll.c`](09-structures/structure_array_sort_by_roll.c): Demonstrates sorting an array of structures by an integer member (roll number).
